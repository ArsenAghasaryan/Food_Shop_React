        ...
        <Row>
          ...
          <Col lg='6' md='6'>
            <div className='hero__content'>
              ...
              <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Illo non harum dolores, deleniti fugit sunt!
              </p>
      ...
      <Container>
        <Row>
          ...
          <Col lg='12' className='text-center'>
            ...
            <p className='mb-1 mt-4 feature__text'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Praesentium, molestias.</p>
            <p className='feature__text'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae, laboriosam.</p>
          </Col>

          {
            featureData.map((item, index) => (
              <Col lg='4' md='6' sm='6' key={index} className='mt-5'>      
                <div className='featur__item text-center p-4'>
        ...
        <Row>
          ...
          <Col lg='6' md='6'>
            <div className="why__tasty-treat">
              ...
              <p className='tasty__treat-desc'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Praesentium similique, rem mollitia ducimus quaerat modi vel voluptatum quidem neque nobis quam officia beatae recusandae quas, eligendi inventore ratione! Voluptates, ex!</p>
              <ListGroup className='mt-4'>
                <ListGroupItem className='border-0 ps-0'>
                  ...
                  <p className='choose__us-desc'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident, voluptatibus!</p>
                </ListGroupItem>
                <ListGroupItem className='border-0 ps-0'>
                  <p className='choose__us-title d-flex align-items-center gap-2'><i className="ri-checkbox-circle-line"></i>Quality support</p>
                  <p className='choose__us-desc'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum, at.</p>
                </ListGroupItem>
                <ListGroupItem className='border-0 ps-0'>
        ...
        <Row>        
          ...
          <Col lg='6' md='6'>
            <div className='testimonial'>
              ...
              <p className='testimonial__desc'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Est officia ipsum voluptatum nemo animi ad saepe aut sint odio dolore!</p>
              <TestimonialSlider />
            </div>
          </Col>

          <Col lg='6' md='6'>
            <img src={networkImg} alt='networImg' className='w-100'/>
          </Col>
